...
#SBATCH --job-name=pc-umb-gpt2-medium-context
...
export RUN_NAME=${DATASET_MODE}-umb-gpt2-medium-context
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umb-gpt2-medium-context
