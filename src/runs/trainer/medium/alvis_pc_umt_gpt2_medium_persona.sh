...
#SBATCH --job-name=pc-umt-gpt2-medium-persona
...
export RUN_NAME=${DATASET_MODE}-umt-gpt2-medium-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-medium-persona
