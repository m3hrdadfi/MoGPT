...
#SBATCH --job-name=pc-umt-gpt2-medium-personacontext
...
export RUN_NAME=${DATASET_MODE}-umt-gpt2-medium-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-medium-personacontext
