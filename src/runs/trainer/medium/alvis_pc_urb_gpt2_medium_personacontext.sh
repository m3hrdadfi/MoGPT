...
#SBATCH --job-name=pc-urb-gpt2-medium-personacontext
...
export RUN_NAME=${DATASET_MODE}-urb-gpt2-medium-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urb-gpt2-medium-personacontext
