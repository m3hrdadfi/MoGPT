...
#SBATCH --job-name=pc-urt-gpt2-medium-context
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-medium-context
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-medium-context
