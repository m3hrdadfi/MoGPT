...
#SBATCH --job-name=pc-urt-gpt2-medium-persona
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-medium-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-medium-persona
