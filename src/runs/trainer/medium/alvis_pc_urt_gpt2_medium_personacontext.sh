...
#SBATCH --job-name=pc-urt-gpt2-medium-personacontext
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-medium-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-medium-personacontext
