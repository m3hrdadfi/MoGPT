...
#SBATCH --job-name=pc-umb-gpt2-small-persona
#SBATCH --error=logs/pc-umb-persona-%J.err.log
#SBATCH --output=logs/pc-umb-persona-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umb-gpt2-small-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umb-gpt2-small-persona
