...
#SBATCH --job-name=pc-umb-gpt2-small-personacontext
#SBATCH --error=logs/pc-umb-personacontext-%J.err.log
#SBATCH --output=logs/pc-umb-personacontext-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umb-gpt2-small-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umb-gpt2-small-personacontext
