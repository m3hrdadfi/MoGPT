...
#SBATCH --job-name=pc-umb-gpt2-small-random
#SBATCH --error=logs/pc-umb-random-%J.err.log
#SBATCH --output=logs/pc-umb-random-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umb-gpt2-small-random
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umb-gpt2-small-random
