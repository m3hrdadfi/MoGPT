...
#SBATCH --job-name=pc-umt-gpt2-small-context
#SBATCH --error=logs/pc-umt-context-%J.err.log
#SBATCH --output=logs/pc-umt-context-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umt-gpt2-small-context
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-small-context
