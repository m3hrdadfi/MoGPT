...
#SBATCH --job-name=pc-umt-gpt2-small-persona
#SBATCH --error=logs/pc-umt-persona-%J.err.log
#SBATCH --output=logs/pc-umt-persona-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umt-gpt2-small-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-small-persona
