...
#SBATCH --job-name=pc-umt-gpt2-small-personacontext
#SBATCH --error=logs/pc-umt-personacontext-%J.err.log
#SBATCH --output=logs/pc-umt-personacontext-%J.out.log
...
export DATASET_MODE=pc

export CUDA_LAUNCH_BLOCKING=1
export PROJECT_NAME=AuxGPT2-Research
export RUN_NAME=${DATASET_MODE}-umt-gpt2-small-personacontext
...
#--deepspeed_sharding
export DO_TYPE=TOKEN
export DO_ON=PERSONA+CONTEXT
export ALPHA=1.0
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-small-personacontext
