...
#SBATCH --job-name=pc-umt-gpt2-small-random
#SBATCH --error=logs/pc-umt-random-%J.err.log
#SBATCH --output=logs/pc-umt-random-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-umt-gpt2-small-random
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-umt-gpt2-small-random
