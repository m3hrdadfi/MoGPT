...
#SBATCH --job-name=pc-urb-gpt2-small-context
#SBATCH --error=logs/pc-urb-context-%J.err.log
#SBATCH --output=logs/pc-urb-context-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urb-gpt2-small-context
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urb-gpt2-small-context
