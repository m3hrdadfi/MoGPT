...
#SBATCH --job-name=pc-urb-gpt2-small-persona
#SBATCH --error=logs/pc-urb-persona-%J.err.log
#SBATCH --output=logs/pc-urb-persona-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urb-gpt2-small-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urb-gpt2-small-persona
