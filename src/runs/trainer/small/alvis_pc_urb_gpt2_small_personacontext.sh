...
#SBATCH --job-name=pc-urb-gpt2-small-personacontext
#SBATCH --error=logs/pc-urb-personacontext-%J.err.log
#SBATCH --output=logs/pc-urb-personacontext-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urb-gpt2-small-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urb-gpt2-small-personacontext
