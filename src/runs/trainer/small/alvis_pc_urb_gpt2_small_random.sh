...
#SBATCH --job-name=pc-urb-gpt2-small-random
#SBATCH --error=logs/pc-urb-random-%J.err.log
#SBATCH --output=logs/pc-urb-random-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urb-gpt2-small-random
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urb-gpt2-small-random
