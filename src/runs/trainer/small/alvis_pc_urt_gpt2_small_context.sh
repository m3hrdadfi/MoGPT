...
#SBATCH --job-name=pc-urt-gpt2-small-context
#SBATCH --error=logs/pc-urt-context-%J.err.log
#SBATCH --output=logs/pc-urt-context-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-small-context
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-small-context
