...
#SBATCH --job-name=pc-urt-gpt2-small-persona
#SBATCH --error=logs/pc-urt-persona-%J.err.log
#SBATCH --output=logs/pc-urt-persona-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-small-persona
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-small-persona
