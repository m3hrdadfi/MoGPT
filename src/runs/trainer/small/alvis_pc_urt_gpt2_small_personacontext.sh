...
#SBATCH --job-name=pc-urt-gpt2-small-personacontext
#SBATCH --error=logs/pc-urt-personacontext-%J.err.log
#SBATCH --output=logs/pc-urt-personacontext-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-small-personacontext
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-small-personacontext
