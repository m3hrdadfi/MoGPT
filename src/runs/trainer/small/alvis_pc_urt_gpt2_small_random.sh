...
#SBATCH --job-name=pc-urt-gpt2-small-random
#SBATCH --error=logs/pc-urt-random-%J.err.log
#SBATCH --output=logs/pc-urt-random-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-urt-gpt2-small-random
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-urt-gpt2-small-random
