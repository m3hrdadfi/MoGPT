...
#SBATCH --job-name=pc-vanilla-gpt2-small
#SBATCH --error=logs/pc-vanilla-%J.err.log
#SBATCH --output=logs/pc-vanilla-%J.out.log
...
export RUN_NAME=${DATASET_MODE}-vanilla-gpt2-small
...
export HUB_MODEL_ID=m3hrdadfi/${DATASET_MODE}-vanilla-gpt2-small
...
python run_trainer_vanilla_gpt2.py \
